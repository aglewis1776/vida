  ...
  <div class="w-full max-w-md flex flex-col flex-1 bg-[#F9FAFB] border border-[#F9FAFB] rounded-none shadow-none min-h-screen" style="min-height: 100vh;">
    <div class="space-y-6 bg-[#F9FAFB]" style="margin:0;">
			<div class="flex justify-center gap-4 mb-6">
				<!-- Only keep the Contas Recorrentes button -->
				<button
			...
			<!-- New tab design for Ativas and Vencidas, placed below the current buttons -->
			<div class="flex w-full max-w-md mx-auto rounded-[12px] bg-[#E2E8F0] p-1 mb-6">
				<button
					class="flex-1 px-4 py-2 rounded-l-[12px] rounded-r-none font-semibold focus:outline-none transition text-sm font-['Nunito_Sans','Nunito Sans',sans-serif]"
				...
				<button
					class="flex-1 px-4 py-2 rounded-r-[12px] rounded-l-none font-semibold focus:outline-none transition text-sm font-['Nunito_Sans','Nunito Sans',sans-serif]"
				...
				<div>
					{#if $paidBills && $paidBills.length > 0}
						{#each $paidBills as bill (bill.id)}
							<div class="overflow-hidden rounded-lg bg-white shadow-sm border border-gray-200 text-xs font-['Nunito_Sans','Nunito Sans',sans-serif] text-[#1F2937] mb-0" style="margin-bottom:12px;">
								<div class="relative">
